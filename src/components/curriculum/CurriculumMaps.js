            ...
            <table className={tableClass}>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className={tdClass}><Topic name="Ratios" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.youtube.com/watch?v=L2G563dF9cM" code="6.RP.A" desc="Understand ratio concepts and use ratio reasoning to solve problems." /></td>
                        <td className={tdClass}><Topic name="Unit Rates" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-ratios-prop-topic" code="6.RP.A" desc="Understand the concept of a unit rate associated with a ratio." /></td>
                        <td className={tdClass}><Topic name="Proportions" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-ratio-proportion" code="7.RP.A" desc="Analyze proportional relationships and use them to solve real-world problems." /></td>
                        <td className={tdClass}><Topic name="Fractions/Div" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-arithmetic-operations" code="6.NS.A" desc="Apply and extend previous understandings of division to divide fractions." /></td>
                        <td className={tdClass}><Topic name="Decimals" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-arithmetic-operations" code="6.NS.B" desc="Compute fluently with multi-digit numbers and find common factors." /></td>
                        <td className={tdClass}><Topic name="Rational Nums" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-negative-number-topic" code="6.NS.C" desc="Apply previous understandings of numbers to the system of rational numbers." /></td>
                        <td className={tdClass}><Topic name="Add/Sub Rational" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-negative-numbers-add-and-subtract" code="7.NS.A" desc="Add and subtract rational numbers." /></td>
                        <td className={tdClass}><Topic name="Mult/Div Rational" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-negative-numbers-multiply-and-divide" code="7.NS.A" desc="Multiply and divide rational numbers." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-sky-700`}>Algebra (9-12)</td>
                        <td className={tdClass}><Topic name="Eq & Inequalities" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:solve-equations-inequalities" code="A1.REI.A" desc="Understand solving equations as a process of reasoning." /></td>
                        <td className={tdClass}><Topic name="Linear Eq (1 Var)" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:solve-equations-inequalities" code="A1.REI.B" desc="Solve equations and inequalities in one variable." /></td>
                        <td className={tdClass}><Topic name="Systems of Eq" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:systems-of-equations" code="A1.REI.C" desc="Solve systems of linear equations." /></td>
                        <td className={tdClass}><Topic name="Graphing Eq" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:linear-equations-graphs" code="A1.REI.D" desc="Represent and solve equations / inequalities graphically." /></td>
                        <td className={tdClass}><Topic name="Func Intro" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:functions" code="A1.IF.A" desc="Understand the concept of a function and use function notation." /></td>
                        <td className={tdClass}><Topic name="Interpreting Func" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:functions" code="A1.IF.B" desc="Interpret functions that arise in applications in terms of the context." /></td>
                        <td className={tdClass}><Topic name="Building Func" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:functions" code="A1.BF.A" desc="Build a function that models a relationship between two quantities." /></td>
                        <td className={tdClass}><Topic name="Linear vs Exp" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:exponential-growth-decay" code="A1.LQE.A" desc="Construct and compare linear, quadratic, and exponential models." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-purple-700`}>Geometry (9-12)</td>
                        <td className={tdClass}><Topic name="Geo Basics" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-foundations" code="G.CO.A" desc="Experiment with transformations in the plane." /></td>
                        <td className={tdClass}><Topic name="Transformations" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-transformations" code="G.CO.A" desc="Represent transformations in the plane." /></td>
                        <td className={tdClass}><Topic name="Congruence" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-congruence" code="G.CO.B" desc="Understand congruence in terms of rigid motions." /></td>
                        <td className={tdClass}><Topic name="Proof Basics" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-congruence" code="G.CO.C" desc="Prove geometric theorems." /></td>
                        <td className={tdClass}><Topic name="Triangles" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-congruence" code="G.CO.C" desc="Prove theorems about triangles." /></td>
                        <td className={tdClass}><Topic name="Parallelograms" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-congruence" code="G.CO.C" desc="Prove theorems about parallelograms." /></td>
                        <td className={tdClass}><Topic name="Constructions" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-congruence" code="G.CO.D" desc="Make geometric constructions." /></td>
                        <td className={tdClass}><Topic name="Similarity" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-similarity" code="G.SRT.A" desc="Understand similarity in terms of similarity transformations." /></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div className={blockClass}>
            <table className={tableClass}>
                ...
                <tbody>
                    <tr>
                        <td className={`${tdSubjectClass} text-indigo-700`}>MS Math (6-8)</td>
                        <td className={tdClass}><Topic name="Expressions" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-expressions-and-variables" code="6.EEI.A" desc="Apply and extend previous understandings of arithmetic to algebraic expressions." /></td>
                        <td className={tdClass}><Topic name="Eq (1 Var)" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-equations-and-inequalities" code="6.EEI.B" desc="Reason about and solve one-variable equations and inequalities." /></td>
                        <td className={tdClass}><Topic name="Prop of Ops" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-variables-expressions" code="7.EEI.A" desc="Use properties of operations to generate equivalent expressions." /></td>
                        <td className={tdClass}><Topic name="Multi-Step Eqs" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-variables-expressions" code="7.EEI.B" desc="Solve multi-step real-life and mathematical problems posed with positive and negative rational numbers." /></td>
                        <td className={tdClass}><Topic name="Exponents" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-numbers-operations" code="8.EEI.A" desc="Work with radicals and integer exponents." /></td>
                        <td className={tdClass}><Topic name="Sci Notation" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-numbers-operations" code="8.EEI.A" desc="Use numbers expressed in the form of a single digit times an integer power of 10." /></td>
                        <td className={tdClass}><Topic name="Proportional Rel" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-linear-equations-functions" code="8.EEI.B" desc="Understand the connections between proportional relationships, lines, and linear equations." /></td>
                        <td className={breakClass}>🍂 Break</td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-sky-700`}>Algebra (9-12)</td>
                        <td className={tdClass}><Topic name="Structure in Exp" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:foundation-algebra" code="A1.SSE.A" desc="Interpret the structure of expressions." /></td>
                        <td className={tdClass}><Topic name="Polynomials" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratics-multiplying-factoring" code="A1.APR.A" desc="Perform arithmetic operations on polynomials." /></td>
                        <td className={tdClass}><Topic name="Creating Eq" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:solve-equations-inequalities" code="A1.CED.A" desc="Create equations that describe numbers or relationships." /></td>
                        <td className={tdClass}><Topic name="Factoring" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratics-multiplying-factoring" code="A1.SSE.B" desc="Write expressions in equivalent forms to solve problems." /></td>
                        <td className={tdClass}><Topic name="Quadratics Intro" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratic-functions-equations" code="A1.REI.D" desc="Solve quadratic equations." /></td>
                        <td className={tdClass}><Topic name="Quad Formula" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratic-functions-equations" code="A1.REI.D" desc="Solve quadratic equations by inspection, taking square roots, completing the square, the quadratic formula." /></td>
                        <td className={tdClass}><Topic name="Graphing Quads" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratic-functions-equations" code="A1.IF.C" desc="Analyze functions using different representations." /></td>
                        <td className={breakClass}>🍂 Break</td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-purple-700`}>Geometry (9-12)</td>
                        <td className={tdClass}><Topic name="Sim Proofs" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-similarity" code="G.SRT.B" desc="Prove theorems involving similarity." /></td>
                        <td className={tdClass}><Topic name="Right Triangles" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-trig" code="G.SRT.C" desc="Define trigonometric ratios and solve problems involving right triangles." /></td>
                        <td className={tdClass}><Topic name="Trig Ratios" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-trig" code="G.SRT.C" desc="Understand that by similarity, side ratios in right triangles are properties of the angles." /></td>
                        <td className={tdClass}><Topic name="Angles of Elev" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-trig" code="G.SRT.C" desc="Use trigonometric ratios and the Pythagorean Theorem to solve right triangles in applied problems." /></td>
                        <td className={tdClass}><Topic name="Circles Basics" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-circles" code="G.C.A" desc="Understand and apply theorems about circles." /></td>
                        <td className={tdClass}><Topic name="Arcs/Angles" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-circles" code="G.C.A" desc="Identify and describe relationships among inscribed angles, radii, and chords." /></td>
                        <td className={tdClass}><Topic name="Circle Measurement" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-circles" code="G.C.B" desc="Find arc lengths and areas of sectors of circles." /></td>
                        <td className={breakClass}>🍂 Break</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div className={blockClass}>
            <table className={tableClass}>
                ...
                <tbody>
                    <tr>
                        <td className={`${tdSubjectClass} text-indigo-700`}>MS Math (6-8)</td>
                        <td className={tdClass}><Topic name="Linear Eqs" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-linear-equations-functions" code="8.EEI.C" desc="Analyze and solve linear equations and pairs of simultaneous linear equations." /></td>
                        <td className={tdClass}><Topic name="Functions" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-linear-equations-functions" code="8.F.A" desc="Define, evaluate, and compare functions." /></td>
                        <td className={breakClass}>📝 Exams</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={tdClass}><Topic name="Func Modeling" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-linear-equations-functions" code="8.F.B" desc="Use functions to model relationships between quantities." /></td>
                        <td className={tdClass}><Topic name="Geometry Base" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.A" desc="Understand congruence and similarity using physical models, transparencies, or geometry software." /></td>
                        <td className={tdClass}><Topic name="Transformations" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.A" desc="Describe the effect of dilations, translations, rotations, and reflections on two-dimensional figures." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-sky-700`}>Algebra (9-12)</td>
                        <td className={tdClass}><Topic name="Data Stats" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:data" code="A1.DS.A" desc="Summarize, represent, and interpret data on a single count or measurement variable." /></td>
                        <td className={tdClass}><Topic name="2 Var Data" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:data" code="A1.DS.B" desc="Summarize, represent, and interpret data on two categorical and quantitative variables." /></td>
                        <td className={breakClass}>📝 Exams</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={tdClass}><Topic name="Linear Models" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:data" code="A1.DS.C" desc="Interpret linear models." /></td>
                        <td className={tdClass}><Topic name="Complex Nums" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:complex" code="A2.NQ.A" desc="Perform arithmetic operations with complex numbers." /></td>
                        <td className={tdClass}><Topic name="Poly Identities" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:poly" code="A2.APR.A" desc="Use polynomial identities to solve problems." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-purple-700`}>Geometry (9-12)</td>
                        <td className={tdClass}><Topic name="Expressing Props" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-analytic-geometry" code="G.GPE.A" desc="Translate between the geometric description and the equation for a conic section." /></td>
                        <td className={tdClass}><Topic name="Coords / Proofs" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-analytic-geometry" code="G.GPE.B" desc="Use coordinates to prove simple geometric theorems algebraically." /></td>
                        <td className={breakClass}>📝 Exams</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={breakClass}>❄️ Break</td>
                        <td className={tdClass}><Topic name="Distance" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-analytic-geometry" code="G.GPE.B" desc="Use coordinates to compute perimeters of polygons and areas of triangles." /></td>
                        <td className={tdClass}><Topic name="Vol 2D/3D" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-solid-geometry" code="G.GMD.A" desc="Explain volume formulas and use them to solve problems." /></td>
                        <td className={tdClass}><Topic name="Cross Sections" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/geometry/hs-geo-solid-geometry" code="G.GMD.B" desc="Visualize relationships between two-dimensional and three-dimensional objects." /></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div className={blockClass}>
            <table className={tableClass}>
                ...
                <tbody>
                    <tr>
                        <td className={`${tdSubjectClass} text-indigo-700`}>MS Math (6-8)</td>
                        <td className={tdClass}><Topic name="Pythagorean Thm" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.B" desc="Understand and apply the Pythagorean Theorem." /></td>
                        <td className={tdClass}><Topic name="Distance Coord" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.B" desc="Apply the Pythagorean Theorem to find the distance between two points in a coordinate system." /></td>
                        <td className={tdClass}><Topic name="Volume Cylinders" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.C" desc="Solve real-world and mathematical problems involving volume of cylinders, cones, and spheres." /></td>
                        <td className={tdClass}><Topic name="Volume Spheres" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-geometry" code="8.G.C" desc="Know the formulas for the volumes of cones, cylinders, and spheres and use them to solve real-world and mathematical problems." /></td>
                        <td className={tdClass}><Topic name="Stats Arrays" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-data-statistics" code="6.DSP.A" desc="Develop understanding of statistical variability." /></td>
                        <td className={tdClass}><Topic name="Distributions" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-sixth-grade-math/cc-6th-data-statistics" code="6.DSP.B" desc="Summarize and describe distributions." /></td>
                        <td className={tdClass}><Topic name="Samples" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-probability-statistics" code="7.DSP.A" desc="Use random sampling to draw inferences about a population." /></td>
                        <td className={breakClass}>🌱 Break</td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-sky-700`}>Algebra (9-12)</td>
                        <td className={tdClass}><Topic name="Rational Expr" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:rational" code="A2.APR.B" desc="Rewrite rational expressions." /></td>
                        <td className={tdClass}><Topic name="Creating Eq II" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:eq" code="A2.CED.A" desc="Create equations that describe numbers or relationships." /></td>
                        <td className={tdClass}><Topic name="Eq & Inequalities" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:eq" code="A2.REI.A" desc="Understand solving equations as a process of reasoning." /></td>
                        <td className={tdClass}><Topic name="Systems II" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:eq" code="A2.REI.B" desc="Solve systems of equations." /></td>
                        <td className={tdClass}><Topic name="Graphing II" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:eq" code="A2.REI.C" desc="Represent and solve equations / inequalities graphically." /></td>
                        <td className={tdClass}><Topic name="Func Interpreting" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:functions" code="A2.IF.A" desc="Interpret functions that arise in applications." /></td>
                        <td className={tdClass}><Topic name="Func Analyzing" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:functions" code="A2.IF.B" desc="Analyze functions using different representations." /></td>
                        <td className={breakClass}>🌱 Break</td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-purple-700`}>Geometry (9-12)</td>
                        <td className={tdClass}><Topic name="Prob Basics" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.CP.A" desc="Understand independence and conditional probability." /></td>
                        <td className={tdClass}><Topic name="Cond Prob" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.CP.A" desc="Understand independence and conditional probability and use them to interpret data." /></td>
                        <td className={tdClass}><Topic name="Prob Rules" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.CP.B" desc="Use the rules of probability to compute probabilities of compound events." /></td>
                        <td className={tdClass}><Topic name="Permutations" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.CP.B" desc="Use permutations and combinations to compute probabilities of compound events and solve problems." /></td>
                        <td className={tdClass}><Topic name="Combinations" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.CP.B" desc="Compute probabilities using combinations." /></td>
                        <td className={tdClass}><Topic name="Expected Val" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.MD.A" desc="Calculate expected values and use them to solve problems." /></td>
                        <td className={tdClass}><Topic name="Decisions" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/statistics-probability" code="S.MD.B" desc="Use probability to evaluate outcomes of decisions." /></td>
                        <td className={breakClass}>🌱 Break</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div className={blockClass}>
            <table className={tableClass}>
                ...
                <tbody>
                    <tr>
                        <td className={`${tdSubjectClass} text-indigo-700`}>MS Math (6-8)</td>
                        <td className={tdClass}><Topic name="Populations" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-probability-statistics" code="7.DSP.B" desc="Draw informal comparative inferences about two populations." /></td>
                        <td className={tdClass}><Topic name="Probability Models" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-probability-statistics" code="7.DSP.C" desc="Investigate chance processes and develop, use, and evaluate probability models." /></td>
                        <td className={tdClass}><Topic name="Compound Events" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-probability-statistics" code="7.DSP.C" desc="Find probabilities of compound events using organized lists, tables, tree diagrams, and simulation." /></td>
                        <td className={tdClass}><Topic name="Bivariate Data" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-data" code="8.DSP.A" desc="Investigate patterns of association in bivariate data." /></td>
                        <td className={tdClass}><Topic name="Scatter Plots" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-data" code="8.DSP.A" desc="Construct and interpret scatter plots for bivariate measurement data." /></td>
                        <td className={tdClass}><Topic name="Line of Best Fit" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-data" code="8.DSP.A" desc="Use the equation of a linear model to solve problems in the context of bivariate data." /></td>
                        <td className={tdClass}><Topic name="Project Setup" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math" code="Review" desc="End-of-year review project." /></td>
                        <td className={tdClass}><Topic name="Final Review" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math" code="Review" desc="Comprehensive MS Math Review." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-sky-700`}>Algebra (9-12)</td>
                        <td className={tdClass}><Topic name="Func Building II" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:functions" code="A2.BF.A" desc="Build a function that models a relationship between two quantities." /></td>
                        <td className={tdClass}><Topic name="New Funcs" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:functions" code="A2.BF.B" desc="Build new functions from existing functions." /></td>
                        <td className={tdClass}><Topic name="Exp/Log Models" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Factoring%201.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:logs" code="A2.LQE.A" desc="Construct and compare linear, quadratic, and exponential models." /></td>
                        <td className={tdClass}><Topic name="Logarithms" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Quadratic%20Formula.pdf"} vid="https://www.khanacademy.org/math/algebra2/x2ec2f6f830c9fb89:logs" code="A2.LQE.A" desc="For exponential models, express as a logarithm." /></td>
                        <td className={tdClass}><Topic name="Trig Funcs" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Congruence%20and%20Triangles.pdf"} vid="https://www.khanacademy.org/math/trigonometry" code="A2.TF.A" desc="Extend the domain of trigonometric functions using the unit circle." /></td>
                        <td className={tdClass}><Topic name="Model Periodic" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/Similar%20Triangles.pdf"} vid="https://www.khanacademy.org/math/trigonometry" code="A2.TF.B" desc="Model periodic phenomena with trigonometric functions." /></td>
                        <td className={tdClass}><Topic name="Trig Identities" pdf={"https://cdn.kutasoftware.com/Worksheets/Geo/The%20Pythagorean%20Theorem%20and%20Its%20Converse.pdf"} vid="https://www.khanacademy.org/math/trigonometry" code="A2.TF.C" desc="Prove and apply trigonometric identities." /></td>
                        <td className={tdClass}><Topic name="Final Review" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Properties%20of%20Logarithms.pdf"} vid="https://www.khanacademy.org/math/algebra2" code="Review" desc="Comprehensive Algebra Review." /></td>
                    </tr>
                    <tr>
                        <td className={`${tdSubjectClass} text-purple-700`}>Geometry (9-12)</td>
                        <td className={tdClass}><Topic name="Stat Inference" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg2/Right%20Triangle%20Trig.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.IC.A" desc="Understand and evaluate random processes underlying statistical experiments." /></td>
                        <td className={tdClass}><Topic name="Conclusions" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Evaluating%20Variable%20Expressions.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.IC.B" desc="Make inferences and justify conclusions from sample surveys, experiments, and observational studies." /></td>
                        <td className={tdClass}><Topic name="Margin of Error" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Proportions.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.IC.B" desc="Use data from a sample survey to estimate a population mean or proportion; develop a margin of error." /></td>
                        <td className={tdClass}><Topic name="Compare Treat" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Area%20of%20Triangles.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.IC.B" desc="Use data from a randomized experiment to compare two treatments." /></td>
                        <td className={tdClass}><Topic name="Evaluate Rpts" pdf={"https://cdn.kutasoftware.com/Worksheets/PreAlg/Volumes%20of%20Solids.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.IC.B" desc="Evaluate reports based on data." /></td>
                        <td className={tdClass}><Topic name="Advanced Stats" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Solving%20Proportions.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="S.MD.B" desc="Use probability to evaluate outcomes of decisions." /></td>
                        <td className={tdClass}><Topic name="Data Project" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Graphing%20Lines%20SI.pdf"} vid="https://www.khanacademy.org/math/ap-statistics" code="Project" desc="End-of-year Data Project." /></td>
                        <td className={tdClass}><Topic name="Wrap Up" pdf={"https://cdn.kutasoftware.com/Worksheets/Alg1/Systems%20of%20Equations%20Elimination.pdf"} vid="https://www.khanacademy.org/math/geometry" code="Review" desc="Comprehensive Geometry/Stats Review." /></td>
                    </tr>
                </tbody>
            </table>
        </div>
