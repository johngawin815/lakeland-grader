...
export const MOCK_STUDENTS = [
  ...
  { id: 'mock-s01', studentName: 'Harry Potter', firstName: 'Harry', lastName: 'Potter', gradeLevel: 10, unitName: 'Determination', admitDate: '2024-09-03', expectedDischargeDate: '2025-06-15', district: 'Hogwarts Regional', iep: 'No', active: true },
  { id: 'mock-s02', studentName: 'Katniss Everdeen', firstName: 'Katniss', lastName: 'Everdeen', gradeLevel: 11, unitName: 'Determination', admitDate: '2024-08-20', expectedDischargeDate: '2025-05-30', district: 'District 12 Schools', iep: 'No', active: true },
  { id: 'mock-s03', studentName: 'Naruto Uzumaki', firstName: 'Naruto', lastName: 'Uzumaki', gradeLevel: 9, unitName: 'Determination', admitDate: '2024-10-15', expectedDischargeDate: '2025-08-01', district: 'Konoha Academy District', iep: 'Yes', active: true },
  { id: 'mock-s04', studentName: 'Hermione Granger', firstName: 'Hermione', lastName: 'Granger', gradeLevel: 11, unitName: 'Determination', admitDate: '2024-09-03', expectedDischargeDate: '2025-06-15', district: 'Hogwarts Regional', iep: 'No', active: true },
  { id: 'mock-s05', studentName: 'Rocky Balboa', firstName: 'Rocky', lastName: 'Balboa', gradeLevel: 10, unitName: 'Determination', admitDate: '2024-11-01', expectedDischargeDate: '2025-09-01', district: 'Philadelphia City Schools', iep: 'Yes', active: true },
  { id: 'mock-s06', studentName: 'Mulan Hua', firstName: 'Mulan', lastName: 'Hua', gradeLevel: 12, unitName: 'Determination', admitDate: '2024-07-15', expectedDischargeDate: '2025-04-30', district: 'Imperial Valley Unified', iep: 'No', active: true },

  // === DISCOVERY (yellow) — curiosity & exploration ===
  { id: 'mock-s07', studentName: 'Frodo Baggins', firstName: 'Frodo', lastName: 'Baggins', gradeLevel: 9, unitName: 'Discovery', admitDate: '2024-09-10', expectedDischargeDate: '2025-07-01', district: 'Shire Regional Schools', iep: 'No', active: true },
  { id: 'mock-s08', studentName: 'Wednesday Addams', firstName: 'Wednesday', lastName: 'Addams', gradeLevel: 10, unitName: 'Discovery', admitDate: '2024-08-28', expectedDischargeDate: '2025-06-20', district: 'Nevermore Academy District', iep: 'No', active: true },
  { id: 'mock-s09', studentName: 'Sherlock Holmes', firstName: 'Sherlock', lastName: 'Holmes', gradeLevel: 11, unitName: 'Discovery', admitDate: '2024-09-05', expectedDischargeDate: '2025-06-01', district: 'Baker Street Prep District', iep: 'No', active: true },
  { id: 'mock-s10', studentName: 'Luna Lovegood', firstName: 'Luna', lastName: 'Lovegood', gradeLevel: 10, unitName: 'Discovery', admitDate: '2024-10-01', expectedDischargeDate: '2025-07-15', district: 'Hogwarts Regional', iep: 'Yes', active: true },
  { id: 'mock-s11', studentName: 'Nancy Drew', firstName: 'Nancy', lastName: 'Drew', gradeLevel: 11, unitName: 'Discovery', admitDate: '2024-08-15', expectedDischargeDate: '2025-05-15', district: 'River Heights Schools', iep: 'No', active: true },
  { id: 'mock-s12', studentName: 'Newt Scamander', firstName: 'Newt', lastName: 'Scamander', gradeLevel: 12, unitName: 'Discovery', admitDate: '2024-09-01', expectedDischargeDate: '2025-06-30', district: 'Ministry Academy District', iep: 'No', active: true },

  // === FREEDOM (sky) — independence & spirit ===
  { id: 'mock-s13', studentName: 'Robin Hood', firstName: 'Robin', lastName: 'Hood', gradeLevel: 11, unitName: 'Freedom', admitDate: '2024-10-20', expectedDischargeDate: '2025-08-15', district: 'Sherwood Forest District', iep: 'No', active: true },
  { id: 'mock-s14', studentName: 'Huck Finn', firstName: 'Huck', lastName: 'Finn', gradeLevel: 9, unitName: 'Freedom', admitDate: '2024-09-15', expectedDischargeDate: '2025-07-01', district: 'Hannibal Township Schools', iep: 'Yes', active: true },
  { id: 'mock-s15', studentName: 'Arya Stark', firstName: 'Arya', lastName: 'Stark', gradeLevel: 10, unitName: 'Freedom', admitDate: '2024-08-25', expectedDischargeDate: '2025-06-10', district: 'Winterfell Academy District', iep: 'No', active: true },
  { id: 'mock-s16', studentName: 'Ferris Bueller', firstName: 'Ferris', lastName: 'Bueller', gradeLevel: 11, unitName: 'Freedom', admitDate: '2024-11-10', expectedDischargeDate: '2025-09-15', district: 'Shermer Township Schools', iep: 'No', active: true },
  { id: 'mock-s17', studentName: 'Rapunzel Corona', firstName: 'Rapunzel', lastName: 'Corona', gradeLevel: 10, unitName: 'Freedom', admitDate: '2024-09-20', expectedDischargeDate: '2025-06-25', district: 'Corona Kingdom Schools', iep: 'No', active: true },
  { id: 'mock-s18', studentName: 'Peter Pan', firstName: 'Peter', lastName: 'Pan', gradeLevel: 9, unitName: 'Freedom', admitDate: '2024-10-05', expectedDischargeDate: '2025-08-01', district: 'Neverland Schools', iep: 'Yes', active: true },

  // === HARMONY (green) — peace & balance ===
  { id: 'mock-s19', studentName: 'Samwise Gamgee', firstName: 'Samwise', lastName: 'Gamgee', gradeLevel: 9, unitName: 'Harmony', admitDate: '2024-09-10', expectedDischargeDate: '2025-07-01', district: 'Shire Regional Schools', iep: 'No', active: true },
  { id: 'mock-s20', studentName: 'Belle French', firstName: 'Belle', lastName: 'French', gradeLevel: 10, unitName: 'Harmony', admitDate: '2024-08-18', expectedDischargeDate: '2025-06-15', district: 'Villeneuve Township Schools', iep: 'No', active: true },
  { id: 'mock-s21', studentName: 'Atticus Finch', firstName: 'Atticus', lastName: 'Finch', gradeLevel: 12, unitName: 'Harmony', admitDate: '2024-07-20', expectedDischargeDate: '2025-04-30', district: 'Maycomb County Schools', iep: 'No', active: true },
  { id: 'mock-s22', studentName: 'Cinderella Tremaine', firstName: 'Cinderella', lastName: 'Tremaine', gradeLevel: 10, unitName: 'Harmony', admitDate: '2024-10-10', expectedDischargeDate: '2025-08-01', district: 'Charmington Royal Academy', iep: 'Yes', active: true },
  { id: 'mock-s23', studentName: 'Elsa Arendelle', firstName: 'Elsa', lastName: 'Arendelle', gradeLevel: 11, unitName: 'Harmony', admitDate: '2024-09-01', expectedDischargeDate: '2025-06-01', district: 'Arendelle Academy District', iep: 'No', active: true },
  { id: 'mock-s24', studentName: 'Forrest Gump', firstName: 'Forrest', lastName: 'Gump', gradeLevel: 9, unitName: 'Harmony', admitDate: '2024-11-05', expectedDischargeDate: '2025-09-01', district: 'Greenbow County Schools', iep: 'Yes', active: true },

  // === INTEGRITY (orange) — honor & doing right ===
  { id: 'mock-s25', studentName: 'Steve Rogers', firstName: 'Steve', lastName: 'Rogers', gradeLevel: 11, unitName: 'Integrity', admitDate: '2024-09-02', expectedDischargeDate: '2025-06-15', district: 'Brooklyn Technical District', iep: 'No', active: true },
  { id: 'mock-s26', studentName: 'Leia Organa', firstName: 'Leia', lastName: 'Organa', gradeLevel: 12, unitName: 'Integrity', admitDate: '2024-08-12', expectedDischargeDate: '2025-05-20', district: 'Alderaan Academy District', iep: 'No', active: true },
  { id: 'mock-s27', studentName: 'Aragorn Elessar', firstName: 'Aragorn', lastName: 'Elessar', gradeLevel: 12, unitName: 'Integrity', admitDate: '2024-07-25', expectedDischargeDate: '2025-05-01', district: 'Gondor Regional Schools', iep: 'No', active: true },
  { id: 'mock-s28', studentName: 'Jean Valjean', firstName: 'Jean', lastName: 'Valjean', gradeLevel: 11, unitName: 'Integrity', admitDate: '2024-10-01', expectedDischargeDate: '2025-08-01', district: 'Digne Township Schools', iep: 'Yes', active: true },
  { id: 'mock-s29', studentName: 'Diana Prince', firstName: 'Diana', lastName: 'Prince', gradeLevel: 10, unitName: 'Integrity', admitDate: '2024-09-08', expectedDischargeDate: '2025-06-20', district: 'Themyscira Academy District', iep: 'No', active: true },
  { id: 'mock-s30', studentName: 'Luke Skywalker', firstName: 'Luke', lastName: 'Skywalker', gradeLevel: 10, unitName: 'Integrity', admitDate: '2024-09-15', expectedDischargeDate: '2025-07-01', district: 'Tatooine Regional Schools', iep: 'No', active: true },

  // === SERENITY (blue) — calm & wisdom ===
  { id: 'mock-s31', studentName: 'Gandalf Grey', firstName: 'Gandalf', lastName: 'Grey', gradeLevel: 12, unitName: 'Serenity', admitDate: '2024-08-01', expectedDischargeDate: '2025-05-15', district: 'Middle Earth Regional', iep: 'No', active: true },
  { id: 'mock-s32', studentName: 'Mary Poppins', firstName: 'Mary', lastName: 'Poppins', gradeLevel: 11, unitName: 'Serenity', admitDate: '2024-09-05', expectedDischargeDate: '2025-06-15', district: 'Cherry Tree Lane District', iep: 'No', active: true },
  { id: 'mock-s33', studentName: 'Shaggy Rogers', firstName: 'Shaggy', lastName: 'Rogers', gradeLevel: 9, unitName: 'Serenity', admitDate: '2024-10-20', expectedDischargeDate: '2025-08-15', district: 'Coolsville Schools', iep: 'Yes', active: true },
  { id: 'mock-s34', studentName: 'Jasmine Agrabah', firstName: 'Jasmine', lastName: 'Agrabah', gradeLevel: 10, unitName: 'Serenity', admitDate: '2024-09-12', expectedDischargeDate: '2025-06-30', district: 'Agrabah Royal Academy', iep: 'No', active: true },
  { id: 'mock-s35', studentName: 'Iroh Sozin', firstName: 'Iroh', lastName: 'Sozin', gradeLevel: 12, unitName: 'Serenity', admitDate: '2024-07-10', expectedDischargeDate: '2025-04-15', district: 'Ba Sing Se Schools', iep: 'No', active: true },
  { id: 'mock-s36', studentName: 'Totoro Kusakabe', firstName: 'Totoro', lastName: 'Kusakabe', gradeLevel: 9, unitName: 'Serenity', admitDate: '2024-11-01', expectedDischargeDate: '2025-09-01', district: 'Satsuki Regional Schools', iep: 'No', active: true },

  // === DISCHARGED ===
  { id: 'mock-s37', studentName: 'Draco Malfoy', firstName: 'Draco', lastName: 'Malfoy', gradeLevel: 11, unitName: 'Discharged', admitDate: '2024-03-15', expectedDischargeDate: '2024-12-20', district: 'Hogwarts Regional', iep: 'No', active: false },
  { id: 'mock-s38', studentName: 'Loki Laufeyson', firstName: 'Loki', lastName: 'Laufeyson', gradeLevel: 12, unitName: 'Discharged', admitDate: '2024-01-10', expectedDischargeDate: '2024-11-15', district: 'Asgard Preparatory District', iep: 'No', active: false },
  { id: 'mock-s39', studentName: 'Scar Pridelands', firstName: 'Scar', lastName: 'Pridelands', gradeLevel: 10, unitName: 'Discharged', admitDate: '2024-04-01', expectedDischargeDate: '2025-01-10', district: 'Pride Rock Academy', iep: 'Yes', active: false },
];
