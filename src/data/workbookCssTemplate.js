...
2. PAGINATION & AVOIDING BLEED: A single <div class="print-page"> represents one 8.5x11 inch sheet of paper. Do NOT overload a single page. If your content exceeds what can comfortably fit on one printed page, you MUST close the current <div class="print-page"> and start a NEW <div class="print-page"> for the next page. Do not let content bleed off the page!
